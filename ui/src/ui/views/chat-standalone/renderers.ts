...
import { selectSlashArg, selectSlashCommand, tabCompleteSlashCommand } from "./interaction.ts";
...
export function renderSearchBar(requestUpdate: () => void): TemplateResult | typeof nothing {
  ...
  return html`
    <div class="agent-chat__pinned">
      ...
      >
        ...
        <span class="collapse-chevron ${chatViewState.pinnedExpanded ? "" : "collapse-chevron--collapsed"}"
...
export function renderSlashMenu(
  ...
  if (chatViewState.slashMenuMode === "args" && chatViewState.slashMenuCommand && chatViewState.slashMenuArgItems.length > 0) {
    return html`
      <div class="slash-menu" role="listbox" aria-label="Command arguments">
        <div class="slash-menu-group">
          <div class="slash-menu-group__label">
            /${chatViewState.slashMenuCommand.name} ${chatViewState.slashMenuCommand.description}
          </div>
          ${chatViewState.slashMenuArgItems.map(
            (arg, i) => html`
              <div
                class="slash-menu-item ${i === chatViewState.slashMenuIndex ? "slash-menu-item--active" : ""}"
                role="option"
              ...
              >
                ${chatViewState.slashMenuCommand?.icon
                  ? html`<span class="slash-menu-icon">${icons[chatViewState.slashMenuCommand.icon]}</span>`
                  : nothing}
                <span class="slash-menu-name">${arg}</span>
                <span class="slash-menu-desc">/${chatViewState.slashMenuCommand?.name} ${arg}</span>
              </div>
            `,
          )}
        </div>
    ...
    sections.push(html`
      <div class="slash-menu-group">
        ...
        ${entries.map(
          ({ cmd, globalIdx }) => html`
            <div
              class="slash-menu-item ${globalIdx === chatViewState.slashMenuIndex
